...
$("#ardoraQuest").html("<img id='playSound' class='imaLeft' src='index_resources/media/sound.png' alt='Sound' align='left'>"+ "<p>" + questionW[indexG] + "</p>");
...
leV=leV+55;}}
function showButtonNext() {var svg = document.getElementById("ardoraActSVG");svg.style.zIndex = 5000;svg.style.visibility = "visible";while (svg.firstChild) {svg.removeChild(svg.firstChild);};var rect = svg.getBoundingClientRect();var svgWidth = rect.width;var svgHeight = rect.height;
var bgRect = document.createElementNS("http://www.w3.org/2000/svg", "rect");bgRect.setAttribute("x", 0);bgRect.setAttribute("y", 0);bgRect.setAttribute("width", svgWidth);bgRect.setAttribute("height", svgHeight);bgRect.setAttribute("fill", colorBack);bgRect.setAttribute("opacity", "0.5");svg.appendChild(bgRect);var tempText = document.createElementNS("http://www.w3.org/2000/svg", "text");tempText.setAttribute("font-size", "30px");tempText.setAttribute("font-family", fMenssage);tempText.textContent = textBNext;svg.appendChild(tempText);var metricsW = tempText.getBBox().width;svg.removeChild(tempText);var x = svgWidth - metricsW - 50;var y = svgHeight - 30 - 40;var btnWidth = metricsW + 45;var btnHeight = 30 + 20;
var filter = document.createElementNS("http://www.w3.org/2000/svg", "filter");filter.setAttribute("id", "dropShadow");var feDropShadow = document.createElementNS("http://www.w3.org/2000/svg", "feDropShadow");feDropShadow.setAttribute("dx", "4");feDropShadow.setAttribute("dy", "4");feDropShadow.setAttribute("stdDeviation", "4");feDropShadow.setAttribute("flood-color", "black");filter.appendChild(feDropShadow);svg.appendChild(filter);var buttonRect = document.createElementNS("http://www.w3.org/2000/svg", "rect");buttonRect.setAttribute("x", x);buttonRect.setAttribute("y", y);buttonRect.setAttribute("width", btnWidth);buttonRect.setAttribute("height", btnHeight);buttonRect.setAttribute("rx", "5");buttonRect.setAttribute("ry", "5");buttonRect.setAttribute("fill", colorButton);buttonRect.setAttribute("stroke", colorSele);buttonRect.setAttribute("stroke-width", "2");buttonRect.setAttribute("filter", "url(#dropShadow)");svg.appendChild(buttonRect);
var buttonText = document.createElementNS("http://www.w3.org/2000/svg", "text");buttonText.setAttribute("x", x + 10);buttonText.setAttribute("y", y + 24);buttonText.setAttribute("fill", colorText);buttonText.setAttribute("font-size", "30px");buttonText.setAttribute("font-family", fMenssage);buttonText.textContent = textBNext;svg.appendChild(buttonText);$("#ardoraActSVG").focus();
$("#ardoraActSVG").bind("click keypress", function(e) {$("#ardoraActSVG").unbind();svg.style.zIndex = 0;svg.style.visibility = "hidden";$(".bLetter").remove();$(".bGame").remove();$(".letterOk").remove();indexWord = 0;indexG++;paintQuest();paintbGame();paintLetters();$(".bLetter").css("backgroundColor", colorButton);$(".bLetter").css("color", colorBack);$(".bLetter").attr("tabindex", "0");$("#ardoraActSVG").attr("tabindex", "0");$(".bLetter").focus(function(e) {$(this).css("backgroundColor", colorSele);});$(".bLetter").blur(function(e) {$(this).css("backgroundColor", colorButton);});$(".bLetter").keypress(function(e) {if (e.which != 9) {checkLetter($(this));}});});}
function isCorrect(){
}
